...
$cmd.Connection  = $cn
$cmd.CommandText = 'SELECT version_no FROM `gmep_electrical_commands_versions` ORDER BY date_created DESC LIMIT 1'
...
$cmd= New-Object MySql.Data.MySqlClient.MySqlCommand
$cmd.Connection  = $cn
$cmd.CommandText = "INSERT INTO gmep_electrical_commands_versions (id, version_no) VALUES (null, @nextVersion)"
